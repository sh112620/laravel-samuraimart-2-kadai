         ...
         <div class="row">
             ...
             <div class="col-md-3 d-flex align-items-center justify-content-end">
                 <form method="POST" action="<?php echo e(route('carts.store'), false); ?>" class="m-3 align-items-end">
                     ...
                     <input type="hidden" name="carriage" value="<?php echo e(App\Models\Product::find($fav->favoriteable_id)->carriage_flag, false); ?>">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/laravel-samuraimart/resources/views/users/favorite.blade.php ENDPATH**/ ?>